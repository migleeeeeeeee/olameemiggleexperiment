/**
 * Olamee Design System — Time Range Picker Input
 *
 * Mirrors Figma "Top Label - Time Range Picker" (666:40662)
 * and "Side Label - Time Range Picker" (1128:24742).
 *
 * Two time fields side-by-side with joined rounded corners.
 *
 * Variants:
 ...
 *
 * Figma nodes: 666:40662, 1128:24742
 */
...
type TimeRangeSize = keyof typeof sizeConfig;
...
/*  Component                                                    */
/* ────────────────────────────────────────────────────────────── */
export const TimeRangePickerInput = forwardRef<HTMLInputElement, TimeRangePickerInputProps>(
  (
    {
      className,
    ...
    const effectiveSupportingText = supportingText ?? 'HH:MM';
        ...
        <div className={cn('flex w-full', isDisabled && 'opacity-50 cursor-not-allowed')}>
          ...
          >
            <span className={cn('inline-flex items-center justify-center shrink-0', config.iconWrapper)}>
              <ClockIcon size={config.iconSize} />
            </span>
            <input
              ref={startRef}
              type="text"
